...
// 0x0008 (0x1990 - 0x1988)
class AGameState_KOTH_C : public AKSGameState_NeutralBomb
{
public:
	class USceneComponent*                             DefaultSceneRoot;                                         // 0x1988(0x0008) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NonTransactional, CPF_NoDestructor, CPF_HasGetValueTypeHash)
