...
public:
	...
	struct FScriptMulticastDelegate                    CloseButtonClicked;                                       // 0x0530(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_BlueprintAssignable, CPF_BlueprintCallable)
