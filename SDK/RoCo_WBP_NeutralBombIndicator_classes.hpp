...
public:
	...
	struct FKSNeutralBombState                         CurrentBombState;                                         // 0x0560(0x0018) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_NoDestructor)
	struct FKSObjectiveState                           CurrentObjectiveState;                                    // 0x0578(0x0020) (CPF_Edit, CPF_BlueprintVisible, CPF_DisableEditOnInstance, CPF_NoDestructor)
