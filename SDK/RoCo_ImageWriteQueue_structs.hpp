...
#include "RoCo_ImageWriteQueue_enums.hpp"
...
struct FImageWriteOptions
{
	...
	struct FScriptDelegate                             OnComplete;                                               // 0x0004(0x0014) (CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_InstancedReference, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
