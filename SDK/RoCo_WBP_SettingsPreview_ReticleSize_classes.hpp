...
#include "RoCo_WBP_SettingsPreview_ReticleSize_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass WBP_SettingsPreview_ReticleSize.WBP_SettingsPreview_ReticleSize_C");
		return ptr;
	}
