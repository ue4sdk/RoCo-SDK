...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass SettingsInfo_SensitivityGamepadLookADSX.SettingsInfo_SensitivityGamepadLookADSX_C"));
		return ptr;
	}
