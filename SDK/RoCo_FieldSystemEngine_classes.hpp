...
#include "RoCo_FieldSystemEngine_structs.hpp"
...
{
public:
	class UFieldSystem*                                FieldSystem;                                              // 0x0430(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0438(0x0010) MISSED OFFSET
	TArray<TSoftObjectPtr<class AChaosSolverActor>>    SupportedSolvers;                                         // 0x0448(0x0010) (CPF_Edit, CPF_ZeroConstructor, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
