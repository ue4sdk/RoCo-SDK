...
#include "RoCo_WBP_PostMatchLobby_classes.hpp"
...
// Parameters:
// int                            CurrentFocus                   (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
// (FUNC_Public, FUNC_HasOutParms, FUNC_BlueprintCallable, FUNC_BlueprintEvent, FUNC_BlueprintPure)
// Parameters:
// int                            FocusGroup                     (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
// Parameters:
// TArray<int64_t>                PlayerIds                      (CPF_Parm, CPF_OutParm, CPF_HasGetValueTypeHash)
...
// Parameters:
// int                            GroupIndex                     (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
// class UWidget*                 DefaultFocus                   (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
// (FUNC_Public, FUNC_HasOutParms, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent, FUNC_BlueprintPure)
// Parameters:
// TArray<class UWBP_PostMatchNavButton_C*> NavButtons                     (CPF_Parm, CPF_OutParm, CPF_ContainsInstancedReference, CPF_HasGetValueTypeHash)
...
void UWBP_PostMatchLobby_C::GetNavButtons(TArray<class UWBP_PostMatchNavButton_C*>* NavButtons)
{
	...
	struct
	{
		TArray<class UWBP_PostMatchNavButton_C*> NavButtons;
	} params;
...
// (FUNC_Public, FUNC_HasOutParms, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent, FUNC_BlueprintPure)
// Parameters:
// float                          timePlayed                     (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
// Parameters:
// struct FScoreboardStats        ScoreboardStats                (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm)
// bool                           DidWin                         (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor)
...
// (FUNC_Public, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// class UWBP_PostMatchNavButton_C* Widget                         (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
void UWBP_PostMatchLobby_C::HandleTabClicked(class UWBP_PostMatchNavButton_C* Widget)
{
	...
	struct
	{
		class UWBP_PostMatchNavButton_C* Widget;
	} params;
...
// Parameters:
// struct FPlayerRewardsSummary   PlayerSummary                  (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm)
// struct FScoreboardStats        ScoreboardStats                (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm)
...
void UWBP_PostMatchLobby_C::PopulatePostMatch(const struct FPlayerRewardsSummary& PlayerSummary, const struct FScoreboardStats& ScoreboardStats)
{
	...
	struct
	{
		struct FPlayerRewardsSummary   PlayerSummary;
		struct FScoreboardStats        ScoreboardStats;
	} params;
...
// (FUNC_BlueprintEvent)
// Parameters:
// class UKSPlayerInfo*           CurrentPlayerInfo              (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
void UWBP_PostMatchLobby_C::BndEvt__ContextMenu_K2Node_ComponentBoundEvent_7_OnReportPlayer__DelegateSignature(class UKSPlayerInfo* CurrentPlayerInfo)
{
	...
	struct
	{
		class UKSPlayerInfo*           CurrentPlayerInfo;
	} params;
