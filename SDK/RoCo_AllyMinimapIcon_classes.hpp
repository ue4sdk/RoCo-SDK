...
public:
	...
	struct FScriptDelegate                             K2Node_CreateDelegate_OutputDelegate;                     // 0x0360(0x000A) (CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_DuplicateTransient, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData02[0x6];                                       // 0x035D(0x0006) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	struct FScriptDelegate                             K2Node_CreateDelegate_OutputDelegate_2;                   // 0x03FC(0x000A) (CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_DuplicateTransient, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData05[0x6];                                       // 0x03F9(0x0006) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             K2Node_CreateDelegate_OutputDelegate_3;                   // 0x040C(0x000A) (CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_DuplicateTransient, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData06[0x6];                                       // 0x040C(0x0006) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	struct FScriptDelegate                             K2Node_CreateDelegate_OutputDelegate_4;                   // 0x0428(0x000A) (CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_DuplicateTransient, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData08[0x6];                                       // 0x0428(0x0006) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData09[0x6];                                       // 0x043A(0x0006) MISSED OFFSET
	...
	unsigned char                                      UnknownData10[0x5];                                       // 0x044B(0x0005) MISSED OFFSET
	...
	unsigned char                                      UnknownData12[0x4];                                       // 0x047C(0x0004) MISSED OFFSET
	...
	struct FScriptDelegate                             K2Node_CreateDelegate_OutputDelegate_5;                   // 0x0490(0x000A) (CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_DuplicateTransient, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData13[0x6];                                       // 0x0490(0x0006) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             K2Node_CreateDelegate_OutputDelegate_6;                   // 0x04A0(0x000A) (CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_DuplicateTransient, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData14[0x6];                                       // 0x04A0(0x0006) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData15[0x7];                                       // 0x04B1(0x0007) MISSED OFFSET
