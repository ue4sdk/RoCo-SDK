...
#include "RoCo_PlayerShopZone_structs.hpp"
...
// BlueprintGeneratedClass PlayerShopZone.PlayerShopZone_C
// 0x0018 (0x0258 - 0x0240)
class APlayerShopZone_C : public AKSPlayerShopZone
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass PlayerShopZone.PlayerShopZone_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_PlayerShopZone(int EntryPoint);
};
