...
#include "RoCo_FriendlyLobbyCharacter_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass FriendlyLobbyCharacter.FriendlyLobbyCharacter_C"));
		return ptr;
	}
