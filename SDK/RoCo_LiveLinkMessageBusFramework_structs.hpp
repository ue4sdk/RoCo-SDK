...
struct FLiveLinkSubjectFrameMessage
{
	...
	TArray<struct FTransform>                          Transforms;                                               // 0x0008(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	TArray<struct FLiveLinkCurveElement>               Curves;                                                   // 0x0018(0x0010) (CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
