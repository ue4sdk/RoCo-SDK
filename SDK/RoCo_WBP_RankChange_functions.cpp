...
#include "RoCo_WBP_RankChange_classes.hpp"
...
// (FUNC_Public, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// int                            CurrentRank                    (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
// (FUNC_Public, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// bool                           IsWinner                       (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor)
...
// (FUNC_Public, FUNC_HasDefaults, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// struct FPlayerProgression      RankedProgression              (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm)
...
void UWBP_RankChange_C::SetProgressionData(const struct FPlayerProgression& RankedProgression)
{
	...
	struct
	{
		struct FPlayerProgression      RankedProgression;
	} params;

	params.RankedProgression = RankedProgression;
...
// Parameters:
// TArray<struct FPlayerProgression> PlayerProgression              (CPF_ConstParm, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_OutParm, CPF_ReferenceParm, CPF_HasGetValueTypeHash)
