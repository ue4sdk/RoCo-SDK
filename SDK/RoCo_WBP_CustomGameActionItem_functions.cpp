...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_CustomGameActionItem.WBP_CustomGameActionItem_C.SetText"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_CustomGameActionItem.WBP_CustomGameActionItem_C.PreConstruct"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_CustomGameActionItem.WBP_CustomGameActionItem_C.Construct"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function WBP_CustomGameActionItem.WBP_CustomGameActionItem_C.ExecuteUbergraph_WBP_CustomGameActionItem"));
