...
#include "RoCo_ANotifyState_SFXAKEvent_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function ANotifyState_SFXAKEvent.ANotifyState_SFXAKEvent_C.Received_NotifyEnd"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function ANotifyState_SFXAKEvent.ANotifyState_SFXAKEvent_C.Received_NotifyBegin"));
