...
#include "RoCo_CableComponent_classes.hpp"
...
// Parameters:
// TArray<struct FVector>         Locations                      (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
