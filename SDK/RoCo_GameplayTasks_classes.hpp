...
#include "RoCo_GameplayTasks_structs.hpp"
...
public:
	...
	TArray<class UGameplayTask*>                       SimulatedTasks;                                           // 0x00C0(0x0010) (CPF_Net, CPF_ZeroConstructor, CPF_RepNotify, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
	TArray<class UGameplayTask*>                       TaskPriorityQueue;                                        // 0x00D0(0x0010) (CPF_ZeroConstructor, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
