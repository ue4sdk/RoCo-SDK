...
#include "RoCo_EventTracker_Spring2021_GadgetDowns_structs.hpp"
...
// BlueprintGeneratedClass EventTracker_Spring2021_GadgetDowns.EventTracker_Spring2021_GadgetDowns_C
// 0x0010 (0x0200 - 0x01F0)
class UEventTracker_Spring2021_GadgetDowns_C : public UKSEventTracker
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass EventTracker_Spring2021_GadgetDowns.EventTracker_Spring2021_GadgetDowns_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_EventTracker_Spring2021_GadgetDowns(int EntryPoint);
};
