...
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable)
// Parameters:
// bool                           bInAllowInterpolation          (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

void UWidget::SetAllowRenderInterpolation(bool bInAllowInterpolation)
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function UMG.Widget.SetAllowRenderInterpolation"));

	struct
	{
		bool                           bInAllowInterpolation;
	} params;
...
// Parameters:
// struct FSoftObjectPath         SoftPath                       (CPF_ConstParm, CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_ReferenceParm, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
// bool                           bMatchSize                     (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

void UImage::SetBrushFromSoftPath(const struct FSoftObjectPath& SoftPath, bool bMatchSize)
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function UMG.Image.SetBrushFromSoftPath"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function UMG.UserWidget.SetZOrderInViewport"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("DelegateFunction UMG.ComboBoxString.OnClosingEvent__DelegateSignature"));
...
// (FUNC_Final, FUNC_Native, FUNC_Public, FUNC_BlueprintCallable)
// Parameters:
// bool                           bEnableRetainedRendering       (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)

void URetainerBox::SetRetainedRendering(bool bEnableRetainedRendering)
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function UMG.RetainerBox.SetRetainedRendering"));
