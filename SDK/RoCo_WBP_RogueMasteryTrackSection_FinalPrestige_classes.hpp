...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("WidgetBlueprintGeneratedClass WBP_RogueMasteryTrackSection_FinalPrestige.WBP_RogueMasteryTrackSection_FinalPrestige_C");
		return ptr;
	}
