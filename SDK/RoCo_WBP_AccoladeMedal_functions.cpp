...
#include "RoCo_WBP_AccoladeMedal_classes.hpp"
...
// (FUNC_Public, FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// float                          NewPresentationSpeed           (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
void UWBP_AccoladeMedal_C::SetPresentationSpeed(float NewPresentationSpeed)
{
	...
	struct
	{
		float                          NewPresentationSpeed;
	} params;

	params.NewPresentationSpeed = NewPresentationSpeed;
...
// int                            TotalAccolade                  (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
void UWBP_AccoladeMedal_C::PlayMoveAccoladeAnim(int Index, int TotalAccolade)
{
	...
	params.Index = Index;
	params.TotalAccolade = TotalAccolade;
...
// (FUNC_BlueprintCallable, FUNC_BlueprintEvent)
// Parameters:
// float                          NewPositionX                   (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
