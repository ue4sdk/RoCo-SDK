...
{
public:
	class AKSGameState_NeutralBomb*                    Bound_Bomb_Game_State;                                    // 0x0028(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnTemplate, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass EnemyBombCarrierTracker.EnemyBombCarrierTracker_C"));
		return ptr;
	}
	...
	void Bind_Game_And_Player(class AKSGameState_NeutralBomb* Neutral_Bomb_Game_State, class APlayerController* Player_Controller);
};
