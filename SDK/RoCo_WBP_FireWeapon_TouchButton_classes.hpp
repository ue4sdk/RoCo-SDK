...
public:
	...
	struct FScriptMulticastDelegate                    OnButtonPressed;                                          // 0x0288(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_BlueprintAssignable, CPF_BlueprintCallable)
	unsigned char                                      UnknownData02[0xF];                                       // 0x0284(0x000F) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
