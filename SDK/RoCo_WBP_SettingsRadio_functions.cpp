...
#include "RoCo_WBP_SettingsRadio_classes.hpp"
...
// Parameters:
// class UWBP_SettingsRadio_C*    SettingsRadio                  (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
void UWBP_SettingsRadio_C::On_Radio_Button_Selected__DelegateSignature(class UWBP_SettingsRadio_C* SettingsRadio)
{
	...
	struct
	{
		class UWBP_SettingsRadio_C*    SettingsRadio;
	} params;
