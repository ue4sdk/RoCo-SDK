...
public:
	...
	struct FScriptMulticastDelegate                    OnFinishedAllPendingLoadsDel;                             // 0x0048(0x0001) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0048(0x000F) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData01[0x220];                                     // 0x0058(0x0220) MISSED OFFSET
...
public:
	...
	struct FScriptMulticastDelegate                    OnFinishedAllPendingLoadsDel;                             // 0x0108(0x0001) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable, CPF_NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData03[0xF];                                       // 0x00E9(0x000F) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	bool                                               bDelaySkinUpdatesUntilTick;                               // 0x0BB0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
	bool                                               bSkinUpdateIsQueued;                                      // 0x0BB1(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData, CPF_NoDestructor, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0BB2(0x0002) MISSED OFFSET
	struct FName                                       SkeletalMeshKeyword;                                      // 0x0BB4(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0BBC(0x0004) MISSED OFFSET
	class USkeletalMesh*                               FailSafeSkeletalMesh;                                     // 0x0BC0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
	struct FName                                       PhysicsAssetKeyword;                                      // 0x0BC8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
	class UPhysicsAsset*                               FailSafePhysicsAsset;                                     // 0x0BD0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
	struct FName                                       AnimInstanceClassKeyword;                                 // 0x0BD8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
	class UClass*                                      FailSafeAnimClass;                                        // 0x0BE0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_Protected, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
	class UClass*                                      LastSkinnedAnimClass;                                     // 0x0BE8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_Protected, CPF_UObjectWrapper, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
	bool                                               bForceAnimationUpdateOnSkinUpdate;                        // 0x0BF0(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0BF1(0x0007) MISSED OFFSET
	class UMultiSkinObject*                            SkinObject;                                               // 0x0BF8(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)
	struct FScriptMulticastDelegate                    OnAnimInitializedOnSkinnableMeshDel;                      // 0x0C00(0x0001) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable, CPF_NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData03[0xF];                                       // 0x0C00(0x000F) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData04[0x30];                                      // 0x0C10(0x0030) MISSED OFFSET
	bool                                               bAllowMaterialSkinning;                                   // 0x0C40(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData05[0x7];                                       // 0x0C41(0x0007) MISSED OFFSET
	TArray<struct FString>                             MaterialSkinningPrefixes;                                 // 0x0C48(0x0010) (CPF_ZeroConstructor, CPF_Deprecated, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
	unsigned char                                      UnknownData06[0x50];                                      // 0x0C58(0x0050) UNKNOWN PROPERTY: MaterialSkinningPrefixes_New
	unsigned char                                      UnknownData07[0x48];                                      // 0x0CA8(0x0048) MISSED OFFSET
	int                                                ForcedLodModel_Skinned;                                   // 0x0CF0(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPrivate)
