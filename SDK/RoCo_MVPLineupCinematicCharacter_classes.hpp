...
#include "RoCo_MVPLineupCinematicCharacter_structs.hpp"
...
// BlueprintGeneratedClass MVPLineupCinematicCharacter.MVPLineupCinematicCharacter_C
// 0x0048 (0x3DB8 - 0x3D70)
class AMVPLineupCinematicCharacter_C : public AKSLobbyCharacter
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass MVPLineupCinematicCharacter.MVPLineupCinematicCharacter_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_MVPLineupCinematicCharacter(int EntryPoint);
};
