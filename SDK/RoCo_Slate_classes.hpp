...
#include "RoCo_Slate_structs.hpp"
...
{
public:
	struct FEditableTextBoxStyle                       EditableTextBoxStyle;                                     // 0x0030(0x07F0) (CPF_Edit, CPF_NativeAccessSpecifierPublic)
...
{
public:
	struct FEditableTextStyle                          EditableTextStyle;                                        // 0x0030(0x0218) (CPF_Edit, CPF_NativeAccessSpecifierPublic)
...
{
public:
	struct FTextBlockStyle                             TextBlockStyle;                                           // 0x0030(0x0268) (CPF_Edit, CPF_NativeAccessSpecifierPublic)
