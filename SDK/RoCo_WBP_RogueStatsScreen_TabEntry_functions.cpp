...
#include "RoCo_WBP_RogueStatsScreen_TabEntry_classes.hpp"
...
// Parameters:
// class UKSActivityComponent_MercMastery* MercMasteryStat                (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)
...
void UWBP_RogueStatsScreen_TabEntry_C::OnSelected__DelegateSignature(class UKSActivityComponent_MercMastery* MercMasteryStat)
{
	...
	struct
	{
		class UKSActivityComponent_MercMastery* MercMasteryStat;
	} params;

	params.MercMasteryStat = MercMasteryStat;
