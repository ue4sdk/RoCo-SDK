...
#include "RoCo_WalkinSequence5_Revised_structs.hpp"
...
// BlueprintGeneratedClass WalkinSequence5_Revised.SequenceDirector_C
...
public:
	...
	int                                                ThisTotalNumWalking_6;                                    // 0x0040(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData, CPF_NoDestructor, CPF_HasGetValueTypeHash)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass WalkinSequence5_Revised.SequenceDirector_C");
		return ptr;
	}
	...
	void ShowNamePlate_Index4();
	void ShowNamePlate_Index2();
	void ShowNamePlate_Index3();
	void ShowNamePlate_Index0();
	void ShowNamePlate_Index1();
	void SequenceEvent_1();
	void ShowNameplate_Index4_Event();
	void ShowNameplate_Index3_Event();
