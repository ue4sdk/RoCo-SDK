...
#include "RoCo_EventTracker_Spring2021_MirvDamage_structs.hpp"
...
// BlueprintGeneratedClass EventTracker_Spring2021_MirvDamage.EventTracker_Spring2021_MirvDamage_C
// 0x000C (0x01FC - 0x01F0)
class UEventTracker_Spring2021_MirvDamage_C : public UKSEventTracker
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass EventTracker_Spring2021_MirvDamage.EventTracker_Spring2021_MirvDamage_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_EventTracker_Spring2021_MirvDamage(int EntryPoint);
};
