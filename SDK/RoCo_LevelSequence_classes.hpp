...
#include "RoCo_LevelSequence_structs.hpp"
...
public:
	...
	TArray<class AActor*>                              AdditionalEventReceivers;                                 // 0x0268(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierPublic)
...
public:
	...
	class UClass*                                      DirectorClass;                                            // 0x0490(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
...
{
public:
	struct FLevelSequencePlayerSnapshot                FrameInformation;                                         // 0x0238(0x00B8) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ContainsInstancedReference, CPF_Protected, CPF_NativeAccessSpecifierProtected)
	class ALevelSequenceActor*                         LevelSequenceActor;                                       // 0x02F0(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData, CPF_NoDestructor, CPF_Protected, CPF_HasGetValueTypeHash, CPF_NativeAccessSpecifierProtected)
