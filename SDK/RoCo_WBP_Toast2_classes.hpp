...
public:
	...
	struct FScriptMulticastDelegate                    FinishedOutroAnimation;                                   // 0x05C0(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_BlueprintAssignable, CPF_BlueprintCallable)
