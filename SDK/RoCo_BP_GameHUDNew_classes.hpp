...
public:
	...
	struct FScriptMulticastDelegate                    OnSwimmingChanged;                                        // 0x0698(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_BlueprintAssignable, CPF_BlueprintCallable)
	struct FScriptMulticastDelegate                    HUDMessage;                                               // 0x06A8(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_BlueprintAssignable, CPF_BlueprintCallable)
	...
	struct FScriptMulticastDelegate                    OnRuleWidgetCreated;                                      // 0x0708(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_BlueprintAssignable, CPF_BlueprintCallable)
	...
	struct FScriptMulticastDelegate                    OnHUDReady;                                               // 0x0738(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_BlueprintAssignable, CPF_BlueprintCallable)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_GameHUDNew.BP_GameHUDNew_C"));
		return ptr;
	}
	...
	void HandleOnPhaseChanged(const struct FName& NewPhaseName, const struct FName& PreviousPhaseName);
