...
public:
	...
	struct FScriptDelegate                             K2Node_CreateDelegate_OutputDelegate;                     // 0x0110(0x000A) (CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_DuplicateTransient, CPF_NoDestructor, CPF_NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData04[0x3];                                       // 0x0151(0x0003) MISSED OFFSET
